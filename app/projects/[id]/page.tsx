...
const Project = ({ params: { id } }: Props) => {
    const data = projectsData.filter((item) => item.id === Number(id));
                ...
                >
                    ...
                    <div className="flex lg:w-10/12 w-full flex-col lg:flex-row lg:justify-between justify-center items-center lg:items-start lg:gap-5 gap-2">
                        <div className="bg-gray-100 lg:w-4/12 w-10/12 text-sm">
                            <h1 className="w-full font-bold bg-teal-300 text-white p-2 px-8">
                                Project Details
                            </h1>
                        ...
                        <div className="lg:w-8/12 w-10/12">
                            <h1 className="font-bold mb-4 text-center lg:text-start text-xl mt-4 lg:mt-0">
                                Project Information
                            </h1>
                            <p className="text-sm opacity-70 text-justify lg:text-left">
